...
import KarolDrozdPoza1 from '../images/poza/Karol-Drozd-poza1.jpg';
import KarolDrozdPoza2 from '../images/poza/Karol-Drozd-poza2.jpg';
import KarolDrozdPoza3 from '../images/poza/Karol-Drozd-poza3.jpg';
      ...
      <div className='main-container'>
        <div className='biography'>
          ...
          <p className='biography__paragraph'>
            ...
            <strong>Jarosław Staniek</strong>
            ,
            <strong>Ewelina Adamska-Porczyk</strong>
            ,
            <strong>Joanna Semeńczuk</strong>
            ,
            <strong>Neva Howard.</strong>
          </p>
          <p className='biography__paragraph'>
            Od 2015 roku instruktor tańca i choreograf w fundacji
            {' '}
            <strong>MUSICAMP</strong>
            ,
