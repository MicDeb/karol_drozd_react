export const rockOfAgesPhoto = {
    title: 'Rock of Ages - Teatr Syrena w Warszawie',
    photos: [
        {
...
export const operaZaTrzyGroszePhotos = {
    title: 'Opera za Trzy grosze - Teatr Variete w Krakowie',
    photos: [
        {
...
export const crazyForYouPhotos = {
    title: 'Crazy For You - Opera na Zamku w Szczecinie',
    photos: [
        {
...
export const addamsFamilyPhotos = {
...
export const grimmPhotos = {
    title: 'GRIMM - Uckermarkische Buhnen Schwedt',
    photos: [
        {
...
export const loveStoryPhotos = {
    title: 'Love Story - Nowy Teatr w Słupsku',
    photos: [
        {
...
export const famePhotos = {
    title: 'FAME - Mazowiecki Teatr Muzyczny',
    photos: [
        {
